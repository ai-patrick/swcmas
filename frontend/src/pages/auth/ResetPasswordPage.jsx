...
const ResetPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-950 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-[20%] right-[10%] w-72 h-72 bg-emerald-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 dark:opacity-10 animate-blob animation-delay-2000"></div>
      ...
      <div className="max-w-md w-full space-y-8 glass-panel p-10 rounded-3xl relative z-10">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          {message && (
            <div className="p-4 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 rounded-xl text-sm text-emerald-600 dark:text-emerald-400 text-center animate-fade-in">
              {message}
            </div>
          )}
          {error && (
